    ...
    public class KinematicCharacterSystem : MonoBehaviour
    {
        ...
        public static void PreSimulationInterpolationUpdate(float deltaTime)
        {
            ...
            for (int i = 0; i < CharacterMotors.Count; i++)
            {
                ...
                motor.Transform.SetPositionAndRotation(motor.TransientPosition, motor.TransientRotation.normalized);
            }
            ...
            for (int i = 0; i < PhysicsMovers.Count; i++)
            {
                ...
                mover.Transform.SetPositionAndRotation(mover.TransientPosition, mover.TransientRotation.normalized);
